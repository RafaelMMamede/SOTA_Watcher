...
copied verbatim from the supplied PDF page. Keep each reason to one concise sentence.
Return every criterion once. Human reviewers make final decisions.
...
short contiguous quote copied verbatim from the supplied page. For uncertain,
use an empty evidence array. Keep each reason to one concise sentence.'''
